...
(27, 'Halfvolle melk', 'Lekkere halfvolle melk van Everyday', '0.65', 200, 1),
(28, 'Volle melk', 'Lekkere volle melk van Everyday.', '0.69', 200, 1),
(29, 'Magere melk', 'Lekkere magere melk van Everyday.', '0.59', 150, 1),
(30, 'Amandel melk', 'Deze amandelmelk is ongezoet en 100% plantaardig. De Amandelmelk van Blue Diamond is vrij van gluten en lactose en heeft een heerlijke smaak. De drank is een bron van calcium, potasium en vitamine A, B, D en E. Ideaal om te gebruiken voor een gezond en gebalanceerd dieet.', '1.85', 150, 1),
...
(3, 'Normal', 'user', 'example@email.com', '$2y$10$83xlAxpWbL7pMJz3UJraNOPFfc5iUgCuxDXRe.DQMjToXvaxeOx0O', 'Basic house', NULL, NULL, NULL, '2021-12-25 11:38:09', 2, 1);
...
--
ALTER TABLE `categories`
  MODIFY `ID` bigint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `products`
  MODIFY `ID` bigint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
