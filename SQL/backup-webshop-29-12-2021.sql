...
--
-- Host: database:3306
-- Generation Time: Dec 29, 2021 at 01:21 PM
...
(27, 'Halfvolle melk', 'Lekkere halfvolle melk van Everyday', '0.65', 196, 1),
(28, 'Volle melk', 'Lekkere volle melk van Everyday.', '0.69', 200, 1),
(29, 'Magere melk', 'Lekkere magere melk van Everyday.', '0.59', 149, 1),
(30, 'Amandel melk', 'Deze amandelmelk is ongezoet en 100% plantaardig. De Amandelmelk van Blue Diamond is vrij van gluten en lactose en heeft een heerlijke smaak. De drank is een bron van calcium, potasium en vitamine A, B, D en E. Ideaal om te gebruiken voor een gezond en gebalanceerd dieet.', '1.85', 139, 1),
...
(4, 'Test', 'Subject', 'test@gmail.com', '$2y$10$TURXh3sQnRlYdM41CP03Beu82PlRjRqVqFdlH6KQn3UL18YsbJUby', 'Booleanstreet 29, somewhere in belgium', 'Example billing address 400', '4564616547', '2002-11-14', '2021-12-27 20:48:31', 2, 1);
...
--
ALTER TABLE `orders`
  MODIFY `ID` bigint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE `products`
  MODIFY `ID` bigint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
